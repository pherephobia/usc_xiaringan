...
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: ["mystyle.css", "uofsc-fonts.css"]
    nature:
...
other social science studies with graduate students and faculties in our department.
...
- We can also make `blockquotes`
  - we can use `<usc-blockquote>text</usc-blockquote>` 
  - or `>`

<usc-blockquote>This is a blocked quote</usc-blockquote>
